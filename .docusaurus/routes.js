...
export default [
  ...
  {
    path: '/docs',
    component: ComponentCreator('/docs', 'fd9'),
    routes: [
      {
      ...
      {
        path: '/docs/category/nav-refusjon-k27',
        component: ComponentCreator('/docs/category/nav-refusjon-k27', 'e59'),
        exact: true,
        sidebar: "payrollplusSidebar"
      },
      {
      ...
      {
        path: '/docs/payrollplus/k27-module/employee',
        component: ComponentCreator('/docs/payrollplus/k27-module/employee', '7bb'),
        exact: true,
        sidebar: "payrollplusSidebar"
      },
      {
        path: '/docs/payrollplus/k27-module/report',
        component: ComponentCreator('/docs/payrollplus/k27-module/report', '943'),
        exact: true,
        sidebar: "payrollplusSidebar"
      },
      {
        path: '/docs/payrollplus/k27-module/settings',
        component: ComponentCreator('/docs/payrollplus/k27-module/settings', '8ca'),
        exact: true,
        sidebar: "payrollplusSidebar"
      },
      {
      ...
      {
        path: '/docs/payrollplus/raise-module/settings',
        component: ComponentCreator('/docs/payrollplus/raise-module/settings', '0df'),
        exact: true,
        sidebar: "payrollplusSidebar"
      },
      {
